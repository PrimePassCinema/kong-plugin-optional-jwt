...
local OptionalJwtHandler = BasePlugin:extend()


OptionalJwtHandler.PRIORITY = 1005
OptionalJwtHandler.VERSION = "2.1.0"

function OptionalJwtHandler:new()
  OptionalJwtHandler.super.new(self, "optinal-jwt")
end
...
function OptionalJwtHandler:access(conf)
